...
entries  [{status: ”” ,in_time:””,out_time:””,date:” ”}]  },*/
	...
	function registerUser($con, $first_name, $last_name, $email, $phone_no, $create_date){

			$r = Query($con, "insert into users ('first_name', 'last_name', 'email', 'phone_no', 'create_date') values($first_name, $last_name, $email, $phone_no, $create_date)");
			//$last_id = mysql_insert_id($con);
			/*$arr= array("user_id"=>$last_id, "first_name"=>$first_name, "last_name"=>$last_name, "email"=>$email, "phone_no"=>$phone_no, "create_date"=>$create_date);
			return $arr;*/
			return $r;
	}
